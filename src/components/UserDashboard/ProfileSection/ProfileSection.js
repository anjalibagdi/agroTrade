...
import daal from "../../../assets/profile.avif"
...
function Profile() {
  ...
  const [fields,dispatch] =  useReducer(reducer,initialsate)
     ...
     async function Updateprofile(event) {
      ...
      //   }
      // })
      http://localhost:3000/SAVE_20250125_155238.jpg
      return ( <>-
    <div className="row m-0 w-100 h-100" style={{height:"auto"}}>
       <div className="col-12 col-md-6 bg-midgreen p-0 offset-lg-3" id="profileCard">
           ...
           {fields.image? <img src={daal} className="rounded  mx-auto d-block mb-3 " style={{width:"35%",height:"30vh"}} alt=""/>
